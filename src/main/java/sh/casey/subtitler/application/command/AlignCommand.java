...
@Slf4j
@Command(name = "align", aliases = "a", description = "Align subtitles within a specific threshold to a reference file. This will adjust the start/end times of subtitles to closely match the reference file.", sortOptions = false)
